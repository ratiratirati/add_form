...
<div class="add_list">
    <table class="table table-hover">
        ...
        <tbody>
        <?php
        $sql = "SELECT * FROM informacia WHERE user_id='".$_SESSION['user_id']."'";
        ...
        if(mysqli_num_rows($result)){
            while ($row = mysqli_fetch_assoc($result)){
                ...
                echo "<td><form method='post' action='home.php'><input type='hidden' name='deleteid' value='".$row['id']."'> <button name='delete' class=\"btn btn-danger\">წაშლა</button></form></td>";
                echo "</tr>";
            }
        }
        ?>
